...
{
    /*
     * static: there is one value for the variable for all objects of the class.
     ...
     * String literal
     *     is an instance of the String class delinated by double quotes
     *     and must be defined on a single line
     *     "ABCDEF" is a string literal equivalent to new String("ABCEDFEF")
     */
    ...
    public static void main(String[] args)
    {
         ...
         *    
         * Parsing is separating a sequence of characters into token 
         *    based on delimiters.
         *    A token is a meanful sequqnce of characters.
        ...
        /*
         * Best practices:
         *    1. Prompt the user for what you want them to imput
         *    2. use print, not println, such that the curso is at
        ...
        /* 
         * The Math.random static method return a double [0.0 ... 1.0].
         * Often we use the following algorithm to generate a random integer from
     ...
     *    number of seconds and displays via System.out in several formats.
     *    
     * This method is static and, therefore, is independent of the state of a CaesarCipher
     *    object. As a result, this method may be invoked on the class instead of a 
    ...
    public static void printAverageTimeToCrack(long totalSeconds)
    {
         ...
         *    or the Java Standard Library.
         *    
         * For example, in the Math class:
         *    public static final double PI = 3.141592654;
         *    
         * Declares a constant with the final keyword.
         *    If we try to change the value, a compiler error will be generated.
         *    By convention, constarts are in all caps with underscores.
         */
         ...
         * Integer division ( like // operator in Python)
         *    Java does integer divsion when both operands are integers
         * Floating point division ( like /)
         *    Java does floating point division when one or both are
        ...
        /*
         * Use the modulo operator to calculate how many seconds remain
         * 
         ...
         * 
         * If the two operands are of different types, Java attempts to promte of the 
         *   types and then performs the operation.
         *   
         * In this case, both SECONDS_FOR_EVERY_MINUTE and MINUTES_FOR_EVERY_HOUR are ints
         * Java does not perform and promotion, and instead, performs the multiplication
         *   and stores the result as an int. Only after all three multiplications does 
         *   Java promote the int value of the resulting product to a long and then assign
         * The promotion can be too late
         */
        final long SECONDS_FOR_EVERY_YEAR = SECONDS_FOR_EVERY_MINUTE * 
                   MINUTES_FOR_EVERY_HOUR * HOURS_FOR_EVERY_DAY * 
                   DAYS_FOR_EVERY_YEAR;
        /*
         * In this example, the value of SFEY is promoted to a double and then floating-
         *    point division is performed and assigned to yearsAsDecimal
         */
        yearsAsDecimal /= SECONDS_FOR_EVERY_YEAR;
         ...
         * 
         * If we want to round a double to the nearest int value, use Math.round();
         *    public static long round (double value);
         *    public static int round(float value);
         *    
         * The following divides yearsAsDecimal by 10, then rounds the resulting double
         *    value to the nearest decade, and then casts the resulting long to an int.
         */
    ...
    public static String compressKeyphrase(String keyphrase)
    {
        ...
        for(int i = 0; i < keyphraseLength; i ++)
        {
             ...
             *     For example, instead of -2,
             *     we could specify keyphrase.length()-2 as the argument
             */
             ...
             *  String restOfKeyphrase = keyphrase.substring(i+1,
             *     keyphrase.length());
             * restOfKeyphrase is the rest of the key starting from i + 1
             *  
             * indexOf
             ...
             *   concatenation operator and operands are converted to strings
             */
            if(index == -1)
            {
                compressedKeyphrase += letter;
            }
