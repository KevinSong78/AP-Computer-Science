...
public class CarTest
{
    ...
    public void testGetFuelInTank()
    {
        ...
        /* 
         * The assertEquals method verifies that the texpected value is equal
         *    to the actual (returned) value. If not, the test fails.
         * Specify the expected value first and the actual value second. 
         * For doubles, and only for doubles, specify a third value which
         *    is the epsilon( i.e., how close is close enough to be equal).
         */
        assertEquals(0, amount, 1e-6 /* 1 x10^-6*/);
